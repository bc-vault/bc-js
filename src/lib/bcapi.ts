...
import { BCHttpResponse, Endpoint, HttpResponse, SpaceObject, PasswordType, WalletType, DaemonError, VersionObject, TransactionData, BCDataRefreshStatusCode, BCObject, BCDevice, typeInfoMap, WalletTypeInfo, WalletData, LogLevel, SessionCreateParameters, SessionAuthType, DaemonErrorCodes, WalletDetailsQuery, WalletBatchDataResponse, hexString, AuthorizationHandler, DaemonHttpResponse } from './types'
...
export class BCJS {
	...
	private showAuthPopup(id: string, passwordType: PasswordType): Promise<void> {
	...
	private getSecureWindowResponse(passwordType: PasswordType): Promise<string> {
